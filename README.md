...
Modifying image size in the preprocessing from 32x32 to 256x256 resulted in a significant improvement in the accuracy in the Retinal OCT task **(76.24% -> 97.0%)**. The updated notebook (Retinal_OCT_256x256.ipynb) has been also uploaded. However, the accuracy was not improved much in other tasks.
![table of accuracy](https://github.com/KogenNobori/CNN-medical-image-classification/blob/images/Screenshot%202026-04-27%20at%2012.10.08.png)
...
Each trial achieved **76-86%** accuracy on the testing data depending on the number of epochs in the learning process:
